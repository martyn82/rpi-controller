...
func TestGetRemoteControlInfoContainsValues(t *testing.T) {
    ...
    assert.NotEquals(t, "", instance.Name)
    assert.NotEquals(t, "", instance.IPAddress)
    assert.NotEquals(t, "", instance.MacAddress)
}
...
func TestRemoteControlInfoGetTVAppName(t *testing.T) {
    ...
    assert.Equals(t, instance.Name + APP_SUFFIX, value)
}
...
func TestCommandProcessorPowerOn(t *testing.T) {
    ...
    assert.Equals(t, "\x00\x12\x00metis.iapp.samsung\x15\x00\x00\x00\x00\x10\x00S0VZX1BPV0VST04=", cmd)
}
...
func TestCommandProcessorPowerOff(t *testing.T) {
    ...
    assert.Equals(t, "\x00\x12\x00metis.iapp.samsung\x15\x00\x00\x00\x00\x10\x00S0VZX1BPV0VST0ZG", cmd)
}
...
func TestCommandProcessorMuteToggle(t *testing.T) {
    ...
    assert.Equals(t, "\x00\x12\x00metis.iapp.samsung\x11\x00\x00\x00\x00\f\x00S0VZX01VVEU=", cmd)
}
...
func TestCommandProcessorVolumeUp(t *testing.T) {
    ...
    assert.Equals(t, "\x00\x12\x00metis.iapp.samsung\x11\x00\x00\x00\x00\f\x00S0VZX1ZPTFVQ", cmd)
}
...
func TestCommandProcessorVolumeDown(t *testing.T) {
    ...
    assert.Equals(t, "\x00\x12\x00metis.iapp.samsung\x15\x00\x00\x00\x00\x10\x00S0VZX1ZPTERPV04=", cmd)
}
